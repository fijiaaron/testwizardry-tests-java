...
public class HogwartsRemoteConfigAcceptanceTests
{
	WebDriver driver;
	WebDriverWait wait;
	...
	public HogwartsRemoteConfigAcceptanceTests()
	{
	...
	{
		config = loadConfig("remote.test.properties");
	}

	static public Properties loadConfig(String configFile) throws IOException
	{
		ClassLoader classLoader = HogwartsRemoteConfigAcceptanceTests.class.getClassLoader();
