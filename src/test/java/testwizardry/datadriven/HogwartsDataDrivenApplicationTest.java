package testwizardry.datadriven;
...
public class HogwartsDataDrivenApplicationTest
{
	WebDriver driver;
	WebDriverWait wait;
	...
	public HogwartsDataDrivenApplicationTest(String name, Integer age, String gender, Boolean magical, String expected)
	{
		this.name = name;
		this.age = age;
		this.gender = gender;
